<?php
    ...
    $data;
    if($type == "edit"){
        $data = $program->fetch_program_data_by_id("child", $id);
    }
    $formUrl = "../api/process-program.php?operate=$type&from=child&id=$id&pid=$program_id&title=$title";
?>
<!DOCTYPE html>
        ...
        <div id="mainDiv">
            ...
            <div id="programMain">
                <form action="<?php echo $formUrl; ?>" method="post">
                    <div class="row">
                        <div class="col-12">
                            <h1><?php echo $type == "edit" ? "编辑" : "新增"; ?>子专业</h1>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-12">
                            <label><span class="text-danger">*</span> 名称</label>
                            <input type="text" maxlength="128" class="form-control" name="child_title"
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            ...
                            <textarea type="text" maxlength="5000" class="form-control" rows="4"
                                name="child_content"><?php echo $type == "edit" ? $data["content"] : ""; ?></textarea>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <label>排序</label>
                            <input type="number" max="999" class="form-control" name="child_index"
