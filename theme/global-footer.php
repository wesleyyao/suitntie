    ...
    <div class="container pt-5">
            ...
            <div class="col-lg-7 col-md-8 col-sm-12">
                <div class="row">
                    <div class="col-md-4 col-sm-4 col-xs-12 mb-5">
                        <h5>关于我们</h5>
                        <a href="/about/index.php">公司介绍</a>
                        <a href="/index.php#contactUs">加入我们</a>
                        <a href="/one-on-one/index.php#ourTeachers">导师团队</a>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-12 mb-5">
                        <h5>服务内容</h5>
                        <a href="/tests/dimension-test.php">选专业测试</a>
                        <a href="/one-on-one/index.php">一对一专业科普</a>
                        <a href="/programs/index.php">专业探索</a>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-12 mb-5">
                        <h5>联系我们</h5>
        ...
        <div class="row">
            <div class="col-12 text-center" style="font-size: 0.8em">
                Copyright &copy; 2020 上海西领商务咨询有限公司
            </div>
        </div>
        <div class="row">
            <div class="col-12 text-center">
                <a href="http://www.beian.miit.gov.cn" style="font-size: 0.8em" target="_blank">沪ICP备20008266号</a>
            </div>
        </div>
    </div>
</footer>