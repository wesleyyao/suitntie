...
<body>
    <div class="program-page-main">
            ...
            <div class="row mt-5">
                <div class="col-12">
                    <div class="card one-on-one-promote">
                        <div class="card-body">
                            <img class="program-one-on-one-img d-sm-none d-md-block" src="<?php echo $global_prefix; ?>/asset/image/pics/programs/contact.png" />
                            <div>
                                ...
                                <a class="btn primBtn" href="<?php echo $global_prefix; ?>/one-on-one.php">了解更多</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal fade" id="programDetailsModal" tabindex="-1" role="dialog" aria-labelledby="programDetailsModalTitle" aria-hidden="true">
