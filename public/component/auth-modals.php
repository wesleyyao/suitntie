                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="offset-1 col-10">
                            <input type="text" id="loginEmail" name="login_email" placeholder="&#xf0e0; 邮箱" class="form-control login-required" maxlength="128"/>
                        </div>
                    </div>
                    <br/>
                    <div class="row mb-1">
                    ...
                    <div class="row">
                        <div class="offset-1 col-10">
                            <div class="row">
                                ...
                                href="https://open.weixin.qq.com/connect/qrconnect?appid=<?php echo $appId; ?>&redirect_uri=<?php echo $redirect_url; ?>&response_type=code&scope=snsapi_login&state=<?php echo $state; ?>#wechat_redirect"><i class="fab fa-weixin text-success"></i> 微信登录</a>
                                </div>
                    ...
                    <?php if(isset($_SESSION["auth_message"])): ?>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="alert alert-<?php echo $_SESSION["auth_message"]["type"] == "error" ? "danger" : "success" ?> alert-dismissible fade show">
                                            <i class="<?php echo $_SESSION["auth_message"]["type"] == "error" ? "fas fa-times" : "fas fa-check" ?>"></i>
...
<div class="modal fade" id="userSignUpModal" tabindex="-1" role="dialog" aria-labelledby="userSignupTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <ul class="nav nav-pills" id="signupTabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="phoneSignup-tab" data-toggle="tab" href="#phoneSignup" role="tab" aria-controls="profile" aria-selected="false">短信验证</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="emailSignup-tab" data-toggle="tab" href="#emailSignup" role="tab" aria-controls="contact" aria-selected="false">邮箱</a>
                    </li>
                </ul>
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="phoneSignup" role="tabpanel" aria-labelledby="phoneSignup-tab">
                        <br/>
                        <p>请选择区号，并输入您的手机号码。</p>
                        <div class="row">
                            <div class="col-3">
