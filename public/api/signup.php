<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $tempId = uniqid('', true);
        $result = $customer->user_signup($usr_email, $usr_password, $tempId);
        if($result === "existed"){
            ...
            $email_content = generateEmailContent($usr_email, $tempId);
    ...
    function generateEmailContent($email, $tempId) {
        return "<html>
            <head>
            <meta charset='utf-8'>
            <style>
            ...
            <body style='padding: 15px'>
                ...
                <div style='width: 100%; padding-top: 30px;'>
                    ...
                    <div style='text-align: center'>
                        请点击以下链接，完成验证 
                        <a href='http://suitntie/public/auth/user-signup.php?user=$email&tempId=$tempId'>
                            http://suitntie/public/auth/user-signup.php?user=$email&tempId=$tempId
                        </a>
                    </div>
            </div></body></html>";
    }
