        ...
        <div class="container mt-5 mb-5 pt-5 pb-5">
            ...
            <div class="row mt-5">
                <div class="col-lg-3 col-md-6 col-sm-12 card border-0 mt-5">
                    <div class="teacher-cell center-block text-center card-body d-flex flex-column pl-2 pr-2" style="width:400px;max-width:100%;">
                        <img src="/suitntie/asset/image/photos/Erik.png" alt="teacher"/>
                            ...
                            <label>毕业院校</label>
                            <p>康奈尔大学，滑铁卢大学(全奖)</p>
                            <p class="mb-5 pl-2 pr-2">Erik学长本科毕业于康奈尔大学机械工程专业，研究生获得滑铁卢大学全奖并主攻机械工程机器人方向，曾在金矿公司研究怎么挖金矿，养了三只兔子。</p>
                            <a href="#" class="btn primBtn mt-auto">请教学长姐</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 card border-0 mt-5">
                    <div class="teacher-cell center-block text-center card-body d-flex flex-column pl-2 pr-2" style="width:400px;max-width:100%;">
                        <img src="/suitntie/asset/image/photos/Joyce.png" alt="teacher"/>
                            ...
                            <label>毕业院校</label>
                            <p>剑桥大学，伦敦大学学院（UCL)</p>
                            <p class="mb-5 pl-2 pr-2">Joyce学姐本科毕业于伦敦大学学院（UCL）数学专业，研究生毕业于剑桥大学经济金融学。目前在上海一家外企咨询公司就职。跳舞达人，爱吃茄子。</p>
                            <a href="#" class="btn primBtn mt-auto">请教学长姐</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 card border-0 mt-5">
                    <div class="teacher-cell center-block text-center card-body d-flex flex-column pl-2 pr-2" style="width:400px;max-width:100%;">
                        <img src="/suitntie/asset/image/photos/Cathy.png" alt="teacher"/>
                            ...
                            <label>毕业院校</label>
                            <p>伦敦政经(LSE)</p>
                            <p class="mb-5 pl-2 pr-2">Cathy学姐本科和研究生都毕业于伦敦政治经济学院（LSE）社会学专业，专注研究现代女权运动的推进与男权文化的兴起，喜欢洞察生活中细节且有趣的小事，并联想它与更广阔的社会结构的对接。</p>
                            <a href="#" class="btn primBtn mt-auto">请教学长姐</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 card border-0 mt-5">
                    <div class="teacher-cell center-block text-center card-body d-flex flex-column pl-2 pr-2" style="width:400px;max-width:100%;">
                        <img src="/suitntie/asset/image/photos/Sunny.png" alt="teacher" class="mb-auto"/>
                            ...
                            <label>毕业院校</label>
                            <p>墨尔本大学，纽约大学</p>
                            <p class="mb-5 pl-2 pr-2">Sunny学姐本科毕业于墨尔本大学商科，研究生毕业于纽约大学奢侈品市场和品牌管理专业。热爱时尚领域，曾就职于Vogue、Burberry、Hermes、Loewe。现在是位高定婚纱买手店主理人。</p>
                            <a href="#" class="btn primBtn mt-auto">请教学长姐</a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 card border-0 mt-5">
                    <div class="teacher-cell center-block text-center card-body d-flex flex-column pl-2 pr-2" style="width:400px;max-width:100%;">
                        <img src="/suitntie/asset/image/photos/Ming.png" alt="teacher"/>
                            ...
                            <p class="mb-5 pl-2 pr-2">Ming学姐是广东外语外贸大学翻译专业学士，蒙特雷国际研究院翻译本地化管理硕士，现就职谷歌，担任语言经理。梦想能够解放固化的中国教育现状。有着一百个梦想，一个个慢慢地去实现。</p>
                            <a href="#" class="btn primBtn mt-auto">请教学长姐</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 card border-0 mt-5">
                    <div class="teacher-cell center-block text-center card-body d-flex flex-column pl-2 pr-2" style="width:400px;max-width:100%;">
                        <img src="/suitntie/asset/image/photos/小雨.png" alt="teacher"/>
                            ...
                            <label>毕业院校</label>
                            <p>剑桥大学，伦敦大学学院（UCL)</p>
                            <p class="mb-5 pl-2 pr-2">小雨学姐是伦敦大学学院（UCL）材料与视觉文化（人类学院）的硕士，专注于青年文化与性别研究，曾在国内领先市场咨询公司实习，服务于可口可乐、腾讯等国内外知名品牌。</p>
                            <a href="#" class="btn primBtn mt-auto">请教学长姐</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 card border-0 mt-5">
                    <div class="teacher-cell center-block text-center card-body d-flex flex-column pl-2 pr-2" style="width:400px;max-width:100%;">
                        <img src="/suitntie/asset/image/photos/Violet.png" alt="teacher"/>
                            ...
                            <label>毕业院校</label>
                            <p>中国人民大学，伦敦政经（LSE）</p>
                            <p class="mb-5 pl-2 pr-2">Violet学姐是人大经济学硕士和伦敦政治经济学院（LSE）管理学硕士，LSE全部科目Distinction，目前就职于国内Top互联网公司。不算是个成功的人，但是个走了很多弯路可以分享失败经验的咸鱼。</p>
                            <a href="#" class="btn primBtn mt-auto">请教学长姐</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 card border-0 mt-5">
                    <div class="teacher-cell center-block text-center card-body d-flex flex-column pl-2 pr-2" style="width:400px;max-width:100%;">
                        <img src="/suitntie/asset/image/photos/Maggie.png" alt="teacher" class="mb-auto"/>
                            ...
                            <p class="mb-5 pl-2 pr-2">Maggie学姐本科毕业于伦敦大学学院（UCL）生物医学专业，现于墨尔本大学攻读教育系研究生，专精学生健康方向。目前忙于组织各种关注留学生心理健康的活动。热爱黑猫警长，毕竟万事都有教育意义。</p>
                            <a href="#" class="btn primBtn mt-auto">请教学长姐</a>
                    </div>
                </div>
            </div>
            ...
            <div class="one-on-one-section-2 mt-5">
                ...
                <div class="row">
                    <div class="col-md-10 offset-md-1 col-sm-12 mb-3">
                        <div style="margin-bottom: 10px; position:relative;">
                            <img src="../asset/image/pics/1-on-1/experiment.svg" width="30px"/>
                            <h5 style="margin: 0; position:absolute; bottom:0; left:40px;" class="align-text-bottom"><span >关于大学生活</span></h5>
                        </div>
                    </div>
                    <div class="col-md-5 offset-md-1 col-sm-12">
                        <div>
            ...
            <div class="row fourSteps">
                <div class="col-lg-3 col-md-12 col-sm-12 d-flex align-items-stretch">
                    <div class="card border-0 p-4">
                        ...
                        <p class="col-lg-12 col-md-10 col-sm-10 h-100 justify-content-center">学生通过适途评测获取独家的个人报告；主动探索了报告中最感兴趣的几个专业；并填写了个人信息表。</p>
                        </div></div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-12 col-sm-12 d-flex align-items-stretch">
                    <div class="card border-0 p-4">
                        ...
                        <h3 class="card-title text-center col-lg-12 col-md-2 col-sm-2"><span class="numberCircle lightShadow">2</span></h3>
                            <p class="col-lg-12 col-md-10 col-sm-10 h-100 justify-content-center">适途咨询师根据学生信息进一步与学生沟通，了解学生更多想法，并根据学生需求安排一个或多个一对一专业科普导师。</p>
                        </div></div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-12 col-sm-12 d-flex align-items-stretch">
                    <div class="card border-0 p-4">
                        ...
                        <h3 class="card-title text-center col-lg-12 col-md-2 col-sm-2"><span class="numberCircle lightShadow">3</span></h3>
                            <p class="col-lg-12 col-md-10 col-sm-10 h-100 justify-content-center">一对一专业科普导师收集适途咨询师给到的学生信息，根据约定的时间进行正式视频或音频沟通。</p>
                        </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-12 col-sm-12 d-flex align-items-stretch">
                    <div class="card border-0 p-4">
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="col-lg-12 col-md-10 col-sm-10 h-100 justify-content-center">适途咨询师对学生进行回访，学生可以就与导师沟通的结果进行反馈。</p>
                            </div>
                        </div>
                    </div>
                </div>
