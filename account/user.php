...
<body>
                                ...
                                <div class="account-center-section" id="userProfileSection">
                                    <div class="row">
                                        <div class="col-lg-2 col-md-3 col-sm-4">
                                            <div class="row">
                                                <div class="col-12 text-center mb-5">
                                                    <img src="<?php echo $global_prefix; ?>/asset/image/avatar.png"
                                                        id="profileHeadImg" class="img-cell"
                                                        style="width: 100%; height: auto;" alt="avatar" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-9 col-sm-8">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <button class="btn ghostSecBtn btn-block mb-4" data-toggle="modal"
    ...
    <div id="dimension-result-notification" role="alert" aria-live="assertive" aria-atomic="true" class="toast"
        ...
        <div class="toast-header">
            <img src="<?php echo $global_prefix; ?>/asset/image/notice.png" class="rounded mr-2" alt="..."
    ...
    <script type="module" src="<?php echo $global_prefix; ?>/asset/js/account-center.js" charset="utf-8"></script>
</body>
